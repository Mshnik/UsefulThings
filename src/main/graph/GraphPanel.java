...
public class GraphPanel<V,E> extends JPanel {
	...
	public GraphPanel(Graph<V,E> graph){
		...
		nodes = new HashMap<>();
		edges = new HashMap<>();
		lineStrokeFunc = (l) -> new BasicStroke();
	...
	/** Sets the stringToDrawFunction, used to choose a stroke for each line
	 * Cannot be null.
	 * @param f - the function to use
	 * @throws IllegalArgumentException if f is null.
	 */
		...
		if(draggable) {
			Function<Circle, MouseListener> clickListenerProvider = (c) -> new MouseListener(){
				...
				public void mousePressed(MouseEvent e) {
					c.maxX = GraphPanel.this.getWidth();
					c.maxY = GraphPanel.this.getHeight();
...
//	}
		...
		if(bendable) {
			Function<Line, MouseListener> clickListenerProvider = (l) -> new MouseListener(){
				...
				public void mousePressed(MouseEvent e) {
					...
					l.maxX = GraphPanel.this.getWidth();
					l.maxY = GraphPanel.this.getHeight();
				}
				public void mouseReleased(MouseEvent e) {
					l.clickPoint = null;
	...
	public class Line  extends JPanel{
		...
		public void paintComponent(Graphics g) {
			...
			g2d.setStroke(lineStrokeFunc.apply(this));
			g2d.setColor(getColor());
